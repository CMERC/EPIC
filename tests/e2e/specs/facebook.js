    ...
    cy.register().then(() => {
      ...
      cy.request({
        ...
        cy.request({
          ...
          body: {
            ...
            variables: {
              data: {
                ...
                url: '{"service": "facebook", "profile": "FacebookTest"}',
                isUserGenerated: true,
          ...
          //Go to Profile View
          cy.visit('/web/global/facebook/FacebookTest')
          cy.screenshot('profile-view')

          //Go to Profile View
          cy.visit(
            '/web/global/facebook/FacebookTest/' +
