  ...
  <div class="container contentMain">
    ...
    <div class="card ">
      <div class="post-content-container columns is-gapless is-marginless is-mobile is-multiline"
           v-if="checkProfile">
        <div class="post-media column is-8-desktop is-12-tablet is-12-mobile">
            ...
            <div class="card-content is-paddingless">
              <div class="media">
                ...
                <div class="media-content">
                  ...
                  <a class="link has-text-link has-text-weight-bold is-pulled-right">
                    Follow
                  </a>
                </div>
              </div>
            </div>
            <span class="title is-7">{{allData.userPost.mediaPostPublic.profiles[0].username}} </span>
