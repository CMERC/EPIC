        ...
        <div class="column is-two-thirds"
          ...
          <div class="card">
            ...
            <nav class="level-right is-mobile stats-area">
              <a class="level-item">
                <span>{{getPostCounts('likes')}} Likes</span>
              </a>
              <a class="level-item">
                <span>{{getPostCounts('shares')}} Shares</span>
              </a>
              <a class="level-item">
                <span>{{allData.userPost.mediaPostPublic.comments.length}} Comments</span>
              </a>
            </nav>
...
export default {
  ...
  methods: {
    ...
    showProfile(profileName) {
      ...
      let workspace = this.$router.currentRoute.params.workspace
      this.$router.push({
        path: `/web/${workspace}/${service}/${profileName}`
      })
    },
    getPostCounts(key) {
      let value = 0
