export default {
  methods: {
    echelonMobilityTowedarray(symbolset) {
      if (symbolset == '10') {
        return [
          ...
          {
            code: '24',
            name: 'Army Group/Front',
            sidc: '10031000240000000000'
          },
      ...
      if (symbolset == '30' || symbolset == '35') {
        return [
          ...
          {
            code: '61',
            name: 'Short towed array',
            sidc: '10033000610000000000'
          },
    ...
    headquartersTaskforceDummy(symbolset) {
      if (symbolset) {
        return {
          0: {
            code: 0,
